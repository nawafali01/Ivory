...
export default function Servicehero() {
  return (
    <section className="relative overflow-hidden min-h-[520px] flex items-center justify-center">
      ...
      <div className="relative mx-auto flex max-w-6xl items-center justify-center px-5 py-24">
       ...
       <h1 className="mx-auto font-extrabold tracking-[-0.03em] leading-[1.05] text-[clamp(28px,4.5vw,58px)]">
  ...
  <br />
  <span className="text-white/50 text-[clamp(14px,1.8vw,24px)] font-medium tracking-[0.25em] uppercase">
